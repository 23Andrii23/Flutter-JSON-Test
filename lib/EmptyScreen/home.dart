...
class _HomeState extends State<Home> {
  ...
  Widget currentScreen = UsersPage();
                ...
                children: <Widget>[
                  MaterialButton(
                    ...
                    onPressed: () {
                      setState(() {
                        currentScreen =
                            UsersPage(); // if user taps on this dashboard tab will be active
                        currentTab = 0;
                      });
                    },
                    child: Column(
                  ...
                  MaterialButton(
                    ...
                    onPressed: () {
                      setState(() {
                        currentScreen =
                            Me(); // if user taps on this dashboard tab will be active
                        currentTab = 1;
                      });
                    },
                    child: Column(
                ...
                children: <Widget>[
                  ...
                  MaterialButton(
                    ...
                    onPressed: () {
                      setState(() {
                        currentScreen =
                            Like(); // if user taps on this dashboard tab will be active
                        currentTab = 3;
                      });
                    },
                    child: Column(
